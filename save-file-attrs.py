...
def main():
    ...
    parser = argparse.ArgumentParser('Save and restore file attributes in a directory tree')
    subparsers = parser.add_subparsers(dest='mode', help='Select the mode of operation')
    save_parser = subparsers.add_parser('save', help='Save the attributes of files in the directory tree')
    restore_parser = subparsers.add_parser('restore', help='Restore saved file attributes')
